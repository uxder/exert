...
exports.angular1Link = exports.changeAsync = exports.change = exports.watchable = undefined;

var _watchable = __webpack_require__(125);
...
var _changeAsync = __webpack_require__(128);

var _changeAsync2 = _interopRequireDefault(_changeAsync);

var _angular1Link = __webpack_require__(129);

var _angular1Link2 = _interopRequireDefault(_angular1Link);
...
exports.watchable = _watchable2.default;
exports.change = _change2.default;
exports.changeAsync = _changeAsync2.default;
exports.angular1Link = _angular1Link2.default;
 ...
 */
var watchable = function watchable(options) {
  return function decorator(targetClass) {
    return function () {
      ...
      var patchClass = (0, _mixin.classMixin)(targetClass, {
        ...
        methods: {
           ...
           */
          watchNow: function watchNow(callback) {
            this.subscriptions.push(callback);
            // Immediately call the callback.
            var current = JSON.parse(JSON.stringify(this));
           ...
           */
          watchOnce: function watchOnce(callback) {
            var _this = this;

            var wrappedCallback = function wrappedCallback() {
              callback();
              _this.unwatch(wrappedCallback);
            };
          ...
          toPromise: function toPromise() {
            ...
            return new Promise(function (resolve, reject) {
              var wrappedCallback = function wrappedCallback(current, prev) {
                resolve({ current: current, prev: prev });
                _this2.unwatch(wrappedCallback);
              };
              _this2.subscriptions.push(wrappedCallback);
            });
          },
           ...
           * @private
           */
          publish_: function publish_(current, prev) {
 ...
 * })
 */
var classMixin = function classMixin(targetClass, _ref) {
 ...
 * }
 */
var change = function change(target, name, descriptor) {
  var fn = descriptor.value;
  descriptor.value = function () {
    this.isBulkChanging_ = true;
    var prev = JSON.parse(JSON.stringify(this));
 ...
 * }
 */
var changeAsync = function changeAsync(target, name, descriptor) {
  var fn = descriptor.value;
  descriptor.value = function () {
    var _this = this;
    ...
    var done = function done() {
      var current = JSON.parse(JSON.stringify(_this));
      _this.publish_(current, prev);
    };
    fn.apply(this, [].concat(Array.prototype.slice.call(arguments), [done]));
  };
  return descriptor;
};
exports.default = changeAsync;
module.exports = exports["default"];
 ...
 * }
 */
var angular1Link = function angular1Link(_ref) {
  var stores = _ref.stores,
      scope = _ref.scope;

  for (var key in stores) {
    stores[key].watch(function () {
